...
# 材料参数
specimen.width = 28
specimen.thickness = 1.4
specimen.yield_stress = 0.546
specimen.elastic_modulus = 195

# 载荷参数
specimen.maxload = 1000
specimen.stress_ratio = 0.1
